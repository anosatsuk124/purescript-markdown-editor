...
(function($PS) {
  ...
  var OnValueChange = (function () {
      function OnValueChange(value0) {
          this.value0 = value0;
      };
      OnValueChange.create = function (value0) {
          return new OnValueChange(value0);
      };
      return OnValueChange;
  })();
  var render = function (state) {
      return Halogen_HTML_Elements.div_([ Halogen_HTML_Elements.h1([ Halogen_HTML_Properties.id("title") ])([ Halogen_HTML_Core.text("Markdown Editor written in Purescript") ]), Halogen_HTML_Elements.textarea([ Halogen_HTML_Events.onValueInput(function (s) {
          return new OnValueChange(s);
      }), Halogen_HTML_Properties.value(state.textarea) ]), Halogen_HTML_Elements.p([  ])([ Halogen_HTML_Core.text(Data_Show.show(Data_Show.showString)(state.textarea)) ]), Halogen_HTML_Elements.p([  ])([ Halogen_HTML_Core.text(Data_Show.show(Data_Show.showString)(state.html)) ]) ]);
  };
  ...
  var handleAction = function (v) {
      return Control_Monad_State_Class.modify_(Halogen_Query_HalogenM.monadStateHalogenM)(function (v1) {
          ...
          $5.textarea = v.value0;
          $5.html = Markdownit_Markdownit.markdownIt(v.value0);
          return $5;
      });
  };
